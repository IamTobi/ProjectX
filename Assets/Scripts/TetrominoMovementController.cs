...
{
    public class TetrominoMovementController : MonoBehaviour
    {
        ...
        public void FreeFall()
        {
            if (Time.time - lastFall >= transitionInterval)
            {
                ...
                else
                {
                    ...
                    GetComponent<TetrominoMovementController>().enabled = false;
                    GetComponent<Tetromino>().enabled = false;

                    Managers.GameManager.CurrentTetromino = null;
                }
